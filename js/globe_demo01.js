...
function init() {
	...
	var diffuse = 0xffffff, specular = 1, shininess = 10.0, scale = 100;
	...
	lightRotateControl = gui.add(myGui, 'lightRotate', 0, 2.0);
...
function exportImage() {
	...
	var webglTexture = globeTexture.texture2.__webglTexture;
	img = createImageFromTexture(gl, webglTexture, 2048, 1024);
